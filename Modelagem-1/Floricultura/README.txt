...
Inicialmente, deseja manter um cadastro de todos os seus clientes, mantendo informações
...
Quando um cliente faz uma compra, a mesma é armazenada, mantendo informação sobre
o cliente que fez a compra, a data da compra, o valor total e os produtos comprados.